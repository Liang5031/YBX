 ...
 */
public class DeptItemDialog extends DialogFragment {
    ...
    public static DeptItemDialog newInstance(BindingDeptItem item) {
        DeptItemDialog f = new DeptItemDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCBAppo.setChecked(mItem.isAllowAppointment());
        mCBAssign.setChecked(mItem.isAllowAssignTeam());
        ...
        builder.setMessage(mItem.customername)
                .setPositiveButton("修改权限", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (mItem.isAllowAppointment() != mCBAppo.isChecked()
                                || mItem.isAllowAssignTeam() != mCBAssign.isChecked()) {
                            mItem.setAllowAppointment(mCBAppo.isChecked());
                            mItem.setAllowAssignTeam(mCBAssign.isChecked());
                            mListener.onDeptChange(mItem);
                        }
                    }
                })
                .setNegativeButton("取消关联", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
